 ...
 *------------------------------------------------------------------------------------------------
 *   Purpose:  FormsGUIListeners.java file
 ...
 ***************************************************************************************************************/
public class FormsGUIListeners extends BrowserConfigGUI implements ITestListener{
	...
	public void onTestFailure(ITestResult result) {
		...
		extentTest.get().fail(result.getThrowable()); 				 	//This is used to retrive the failure log and it will send back to this method will be shown in reports
