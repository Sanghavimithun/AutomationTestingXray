...
public class XpoJiraTicketCreationTest extends BrowserConfigGUI {
	...
	XpoDatabaseTest dbTest = new XpoDatabaseTest();

	@DataProvider(name = "data-provider")
	public Object[][] filesList() {
		File folder = new File(System.getProperty("user.dir") + "\\QA XPO Test Files\\Set 1\\");
	...
	public void processOrders(File file) throws IOException, JiraException, Exception {
		...
		String issueSummary = "QA:DEBUG RMA TEST XPO" + " " + currentDate;
		String issueATTACHMENT = System.getProperty("user.dir") + "\\QA XPO Test Files\\Set 1\\" + file.getName();
	...
	// To get the created issue details and download the files from the SFTP server
	public void jiraDetailsWithFiles(String issueKey, XpoShippingOrderLogics jiraServiceProvider)
